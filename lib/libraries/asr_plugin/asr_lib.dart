// ignore_for_file: prefer_final_fields, non_constant_identifier_names, constant_identifier_names
...
/* 这一文件【必须】在每一次 asr_plugin 更新后被更新一次 */
...
class ASRControllerConfig {
  ...
  ASRControllerConfig clone() {
    var obj = ASRControllerConfig.defaultConfig();
    return obj;
  }

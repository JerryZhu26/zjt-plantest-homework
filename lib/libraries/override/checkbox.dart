...
///  * [CupertinoSwitch], a widget with semantics similar to [OverrideCupertinoCheckbox].
...
class OverrideCupertinoCheckbox extends StatefulWidget {
  ...
  const OverrideCupertinoCheckbox({
    super.key,
    required this.value,
    this.tristate = false,
  ...
  ///
  /// [OverrideCupertinoCheckbox] displays a dash when its value is null.
  ///
  ...
  @override
  State<OverrideCupertinoCheckbox> createState() =>
      _OverrideCupertinoCheckboxState();
}

class _OverrideCupertinoCheckboxState extends State<OverrideCupertinoCheckbox>
  ...
  @override
  void didUpdateWidget(OverrideCupertinoCheckbox oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: buildToggleable(
        ...
        size: const Size.square(0.72 * kMinInteractiveDimensionCupertino),
        painter: _painter
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  Rect _outerRectAt(Offset origin) {
    const double size = OverrideCupertinoCheckbox.width;
  ...
  void _drawCheck(Canvas canvas, Offset origin, Paint paint) {
    ...
    const Offset start = Offset(OverrideCupertinoCheckbox.width * 0.25,
        OverrideCupertinoCheckbox.width * 0.52);
    const Offset mid = Offset(OverrideCupertinoCheckbox.width * 0.46,
        OverrideCupertinoCheckbox.width * 0.75);
    const Offset end = Offset(OverrideCupertinoCheckbox.width * 0.72,
        OverrideCupertinoCheckbox.width * 0.29);
  ...
  void _drawDash(Canvas canvas, Offset origin, Paint paint) {
    ...
    const Offset start = Offset(OverrideCupertinoCheckbox.width * 0.25,
        OverrideCupertinoCheckbox.width * 0.5);
    const Offset end = Offset(OverrideCupertinoCheckbox.width * 0.75,
        OverrideCupertinoCheckbox.width * 0.5);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Offset origin = size / 2.0 -
        const Size.square(OverrideCupertinoCheckbox.width) / 2.0 as Offset;
